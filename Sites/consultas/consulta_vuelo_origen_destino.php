...
$query = "SELECT DISTINCT codigos.codigo_icao,c2.codigo_icao,aerodromos.nombre,a2.nombre
...
<table align='center' class="table is-striped">
    ...
    foreach ($viajes as $viaje){
        echo "<tr> <td>$viaje[0]</td><td>$viaje[1]</td><td>$viaje[2]</td><td>$viaje[3]</td></tr>";
    }
    ?>
</table>
